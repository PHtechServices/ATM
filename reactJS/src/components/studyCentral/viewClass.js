...
export default function ClassComponent() {
    ...
    if (soptionval === "pre-primary") {
        y = <Box >
            <Paper elevation={3} style={{ width: 700, height: 50, justifyItems: "center", marginTop: 5 }}>
                <Box style={{ paddingTop: 7 }}>
                    ...
                    <Button variant="contained" style={{ width: 135, marginRight: 2 }} onClick={() => setClassn("1A")}>1A</Button>
                    <Button variant="contained" style={{ width: 135, marginRight: 2 }} onClick={() => setClassn("1B")}>1B</Button>
                </Box>
            </Paper>
        </Box>;
    }
        ...
        y = <Box>
            <Paper elevation={3} style={{ width: 700, height: 50, justifyItems: "center" }}>
                <Box style={{ paddingTop: 7 }}>
                    <Button variant="contained" style={{ width: 100, marginRight: 2 }} onClick={() => setClassn("2A")}>2A</Button>
                    <Button variant="contained" style={{ width: 100, marginRight: 2 }} onClick={() => setClassn("2B")}>2B</Button>
                    <Button variant="contained" style={{ width: 100, marginRight: 2 }} onClick={() => setClassn("3A")}>3A</Button>
                    <Button variant="contained" style={{ width: 100, marginTop: 2 }} onClick={() => setClassn("3B")}>3B</Button>
                </Box>
            </Paper>
            <Paper elevation={3} style={{ width: 700, height: 50, justifyItems: "center", marginTop: 5 }}>
                <Box style={{ paddingTop: 7 }}>
                    <Button variant="contained" style={{ width: 135, marginRight: 2 }} onClick={() => setClassn("4A")}>4A</Button>
                    <Button variant="contained" style={{ width: 135, marginRight: 2 }} onClick={() => setClassn("4B")}>4B</Button>
    ...
    const students = Object.keys(att["data"]).map((key, index) => (
        <TableRow>
            <TableCell align="left">{key}</TableCell>
            <TableCell align="left">{att["data"][key]}</TableCell>
        </TableRow>
